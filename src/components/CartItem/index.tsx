...
import {addItem, CartItem, minusItem, removeItem} from '../../store/slices/cartSlice';
...
const CartItemComp: React.FC<CartItemProps> = ({ id, price, type, name, count, imageUrl, size }) => {
